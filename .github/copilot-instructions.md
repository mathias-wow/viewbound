# Viewbound Development Instructions

Viewbound is a self-hosted travel companion web application built with SvelteKit frontend and Django backend, deployed via Docker.
...
└── install_viewbound.sh # Production installer
```
...
- **Production**: Use `./install_viewbound.sh` installer script
