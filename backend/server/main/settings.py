...
INVITATIONS_EMAIL_SUBJECT_PREFIX = 'Viewbound: '
...
# VIEWBOUND_CDN_URL = getenv('VIEWBOUND_CDN_URL', 'https://cdn.viewbound.app')

# Major release version of Viewbound, not including the patch version date.
VIEWBOUND_RELEASE_VERSION = 'v0.12.0'
