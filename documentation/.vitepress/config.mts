...
export default defineConfig({
  head: [
    ["link", { rel: "icon", href: "/viewbound.png" }],
    ...
    [
      ...
      {
        rel: "me",
        href: "https://mastodon.social/@viewbound",
      },
    ],
  ],
  ...
  transformPageData(pageData) {
    if (pageData.relativePath === "index.md") {
      const jsonLd = {
        ...
        name: "Viewbound",
        url: "https://viewbound.app",
        applicationCategory: "TravelApplication",
        operatingSystem: "Web, Docker, Linux",
        description:
          "Viewbound is a self-hosted platform for tracking and planning travel experiences. Built for modern explorers, it offers trip planning, journaling, tracking and location mapping in one privacy-respecting package.",
        creator: {
          "@type": "Person",
          name: "Sean Morley",
        ...
        license:
          "https://github.com/seanmorley15/viewbound/blob/main/LICENSE",
        screenshot:
          "https://raw.githubusercontent.com/seanmorley15/Viewbound/refs/heads/main/brand/screenshots/adventures.png",
        downloadUrl: "https://github.com/seanmorley15/viewbound",
        sameAs: ["https://github.com/seanmorley15/viewbound"],
        keywords: [
  ...
  themeConfig: {
    ...
    nav: [
      { text: "Home", link: "/" },
      { text: "Docs", link: "/docs/intro/viewbound_overview" },
    ],
    search: {
      provider: "local",
    },
    editLink: {
      pattern:
        "https://github.com/seanmorley15/Viewbound/edit/main/documentation/:path",
    },
    ...
    sidebar: [
      {
        text: "About Viewbound",
        items: [
          {
            text: "Viewbound Overview",
    ...
    socialLinks: [
      { icon: "github", link: "https://github.com/seanmorley15/Viewbound" },
      { icon: "discord", link: "https://discord.gg/wRbQ9Egr8C" },
      { icon: "buymeacoffee", link: "https://buymeacoffee.com/seanmorley15" },
      { icon: "x", link: "https://x.com/ViewboundApp" },
      { icon: "mastodon", link: "https://mastodon.social/@viewbound" },
      { icon: "instagram", link: "https://www.instagram.com/viewboundapp" },
    ],
  },
});
