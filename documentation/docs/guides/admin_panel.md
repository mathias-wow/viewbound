# Viewbound Admin Panel

The Viewbound Admin Panel, powered by Django, is a web-based interface that allows administrators to manage objects in the Viewbound database. The Admin Panel is accessible at the `/admin` endpoint of the Viewbound server. Example: `https://al-server.yourdomain.com/admin`.
