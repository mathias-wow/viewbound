...
Running Viewbound in a **Dev Container** allows you to contribute to the project or work on features locally in a fully reproducible development environment with hot reloading, debugging, and tooling isolated inside Docker.
...
```bash
cd ~
git clone https://github.com/seanmorley15/Viewbound.git
cd Viewbound
```
...
>
> ```bash
> git clone https://github.com/<your-username>/Viewbound.git
> ```
...
Enjoy contributing to Viewbound! 🎉
