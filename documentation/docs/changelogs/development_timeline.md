# Viewbound: Development Timeline & Origin Story

By: Sean Morley, Founder & Lead Developer

This is the timeline of **how Viewbound came to be, how it kept surviving my terrible early design choices, and how it slowly learned to be useful**. I wrote this as a detailed, phase-by-phase story so contributors, users, and future-me can see what decisions were made, why, and what problems we hit (and fixed) along the way.

> TL;DR: started as _NextVenture_, learned web dev the hard way, resurrected as _Viewbound_, switched stacks twice, survived an chaotic Reddit launch, grew through community requests, and today the project is very much alive.

## Quick roadmap

- **Phase 0 — Ideation & Prototyping:** March 2023 → July 2023  
  The seed. Lots of learning, lots of scrapped prototypes.
- **Phase 1 — Viewbound, SvelteKit roots:** March 2024 → July 2024  
...
- While on break I renamed the project to **Viewbound** — it felt better, cleaner, and more fitting than the working title.
...
## Phase 1 — Initial Development of Viewbound (SvelteKit era)
...
## Phase 3 — Defining Viewbound & Community-Guided Growth

**Dates:** September 2024 — June 2025  
**Versions:** v0.7.0 → v0.10.0

This phase is about defining the product: what is Viewbound, what is it not, and how do we make it useful for other people?
...
- Localization: Frontend got translations to make Viewbound accessible to more users.
- Calendar view: added a calendar to visualize trips over time, another highly requested feature.

### Integrations & polish

- **Immich integration** (huge win): Sync photos from Immich to Viewbound adventures. This solved the “where do my travel photos live?” problem for many self-hosters and reduced friction for users who already had an Immich instance.
...
- Docker image downloads crossed **100K** — a concrete, surreal milestone. GitHub stars crossed **1K** shortly after. These numbers matter because they mean people are using and relying on Viewbound.
...
Phase 3 is where Viewbound stopped being “my little project” and started becoming a community-shaped tool. The roadmap was heavily guided by user requests, and that made the app both more useful and more fun to build.
...
This phase is about turning Viewbound from “a promising tool” into “a dependable tool.” It’s less about big rewrites and more about incremental, meaningful improvements.
...
4. **Simplicity wins in deployment**
   - Removing extra containers and simplifying deployment options made Viewbound more approachable for hobbyist hosts — which is the core audience.
...
Viewbound is alive, maintained, and focused on being the best self-hosted travel app it can be: accessible, performant, and useful for trip planning and personal travel history.

Writing this made me realize how much of Viewbound’s identity came from mistakes, feedback, and stubbornness. It’s the result of learning, throwing away things that didn’t work, embracing tools that did, and listening to people who actually used it. I’m proud of how it’s evolved and excited for the next phase.
