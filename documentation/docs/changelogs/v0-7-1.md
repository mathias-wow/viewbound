...
Hi everyone! I am super excited to announce the release of Viewbound v0.7.1. This update includes a lot of improvements that make using Viewbound more enjoyable and accessible. This update is largely community driven as it addresses more than 10 enhancement requests (thanks everyone!).
...
> The **migration guide** can be found here: https://docs.viewbound.app/docs/Guides/nginx_migration
