...
In addition to the primary configuration variables listed above, there are several optional environment variables that can be set to further customize your Viewbound instance. These variables are not required for a basic setup but can enhance functionality and security.
