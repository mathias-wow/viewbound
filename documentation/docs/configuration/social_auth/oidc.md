...
Viewbound can be configured to use OpenID Connect (OIDC) as an identity provider for social authentication. Users can then log in to Viewbound using their OIDC account.
