								...
								<div class="mt-4 p-4 bg-info/10 rounded-lg">
									<p class="text-sm">
										...
										<a
											...
											href="https://viewbound.app/docs/configuration/immich_integration.html"
									...
									<div class="mt-4 p-4 bg-info/10 rounded-lg">
										{#if user.is_staff}
											<p class="text-sm">
												...
												<a
													class="link link-primary"
													href="https://viewbound.app/docs/configuration/google_maps_integration.html"
													target="_blank">{$t('navbar.documentation')}</a
												>
											</p>
									...
									<div class="mt-4 p-4 bg-info/10 rounded-lg">
										{#if user.is_staff}
											<p class="text-sm">
												...
												<a
													class="link link-primary"
													href="https://viewbound.app/docs/configuration/strava_integration.html"
													target="_blank">{$t('navbar.documentation')}</a
												>
											</p>
								...
								{#if !wandererEnabled}
									<div class="mt-4 p-4 bg-info/10 rounded-lg">
										<p class="text-sm">
											...
											<a
												class="link link-primary"
												href="https://viewbound.app/docs/configuration/wanderer_integration.html"
												target="_blank">{$t('navbar.documentation')}</a
											>
										</p>
									</div>
								...
								<div class="space-y-6">
									...
									<div class="p-6 bg-base-200 rounded-xl">
										...
										<div class="alert alert-info">
											...
											<div>
												...
												<a
													href="https://viewbound.app/docs/configuration/social_auth.html"
									...
									<div class="p-6 bg-base-200 rounded-xl">
										<div class="text-center space-y-3">
											<h4 class="font-medium">{$t('about.about')} Viewbound</h4>
											<p>
												{$t('about.license')}
											</p>
											<p class="text-sm text-base-content/70">
											...
											<div class="flex justify-center gap-3 mt-2">
												<a
													href="https://github.com/seanmorley15/Viewbound"
													target="_blank"
												...
												<a
													href="https://github.com/seanmorley15/Viewbound/blob/main/LICENSE"
													target="_blank"
...
<svelte:head>
	<title>User Settings | Viewbound</title>
	<meta
		name="description"
