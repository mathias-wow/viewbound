						...
						<div class="p-8 lg:p-12 flex flex-col justify-center">
							{#if !is_disabled}
								...
								<div class="text-center mb-8">
									<div class="mb-4">
										<h1 class="text-3xl font-bold text-primary mb-1">Viewbound</h1>
...
<svelte:head>
	<title>Sign Up | Viewbound</title>
	<meta
		name="description"
		content="Sign up for Viewbound to explore the world and document your adventures!"
	/>
</svelte:head>
