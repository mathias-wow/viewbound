<div align="center">
  ...
  <img src="brand/viewbound.png" alt="logo" width="200" height="auto" />
  <h1>Viewbound</h1>
...
<h4>
    <a href="https://demo.viewbound.app">View Demo</a>
  <span> · </span>
    <a href="https://viewbound.app">Documentation</a>
  <span> · </span>
...
Starting from a simple idea of tracking travel locations, Viewbound has grown into a full-fledged travel companion. With Viewbound, you can log your adventures, keep track of where you've been on the world map, plan your next trip collaboratively, and share your experiences with friends and family.

Viewbound was created to solve a problem: the lack of a modern, open-source, user-friendly travel companion. Many existing travel apps are either too complex, too expensive, or too closed-off to be useful for the average traveler. Viewbound aims to be the opposite: simple, beautiful, and open to everyone.
...
- **Share Your Experiences** 📸: Share your adventures with friends and family and collaborate on trips together.
  - Locations and itineraries can be shared via a public link or directly with other Viewbound users.
...
The Viewbound Roadmap can be found [here](https://github.com/users/seanmorley15/projects/5)

<!-- Contributing -->

## 👋 Contributing

<a href="https://github.com/seanmorley15/Viewbound/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=seanmorley15/Viewbound" />
</a>
...
Viewbound is available on [Weblate](https://hosted.weblate.org/projects/viewbound/). If you would like to help translate Viewbound into your language, please visit the link and contribute!

<a href="https://hosted.weblate.org/engage/viewbound/">
<img src="https://hosted.weblate.org/widget/viewbound/multi-auto.svg" alt="Translation status" />
</a>
...
Hi! I'm Sean, the creator of Viewbound. I'm a college student and software developer with a passion for travel and adventure. I created Viewbound to help people like me document their adventures and plan new ones effortlessly. As a student, I am always looking for more opportunities to learn and grow, so feel free to reach out via the contact on my website if you would like to collaborate or chat!
...
Viewbound is built and maintained as an open-source project. These incredible supporters help make continued development possible.
...
If you enjoy Viewbound and want to support its development, consider becoming a sponsor.
...
[Become a Sponsor](https://seanmorley.com/sponsor) to help keep Viewbound thriving!
